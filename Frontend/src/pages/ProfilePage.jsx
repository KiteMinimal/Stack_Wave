            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow relative">
                 {isOwnProfile && (
                     <Link
                        ...
                        className="absolute top-4 right-4 inline-flex items-center px-3 py-1 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-xs font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                     >
                 ...
                 <div className="flex flex-col items-center sm:flex-row sm:items-end sm:space-x-5">
                    {/* Avatar */}
                    <div className="flex-shrink-0 mb-4 sm:mb-0 -mt-12 sm:-mt-16"> {/* Pull avatar up slightly */}
                        <UserAvatar
